...
const file_proto_task_proto_rawDesc = "" +
	...
	"\x04task\x18\x01 \x03(\v2\v.tasks.TaskR\x04task2\x8f\x01\n" +
	"\vTaskService\x12A\n" +
	"\n" +
	"CreateTask\x12\x18.tasks.CreateTaskRequest\x1a\x19.tasks.CreateTaskResponse\x12=\n" +
	"\tListTasks\x12\x17.tasks.ListTasksRequest\x1a\x17.tasks.ListTaskResponseB%Z#github.com/AhmedHossam777/grpc-demob\x06proto3"
